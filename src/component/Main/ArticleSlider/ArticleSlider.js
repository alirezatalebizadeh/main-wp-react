  ...
  return (
    <div className='article_part'>
      ...
      <h3 className='title_brand'>
        <AiOutlineLine className='logo logo_black' />
        <span className='green_text'> مقالات </span> ما
        <AiOutlineLine className='logo logo_black' />
      </h3>
        ...
        >
          <SwiperSlide>
            <div className='box_article'>
              <span className='article_btn'>
                {' '}
                <AiOutlineArrowLeft className='icon_btn' />
              </span>
              <div className='article_content'>
                <img
                  className='article_header_img'
                  loading='lazy'
                  src={img1}
                  alt='img_1'
                />
                ...
                <div className='article_footer'>
                  <p>
                    <span className='footer_time'>مرداد 15 - 1402</span>{' '}
                    <BsClock className='footer_icon' />{' '}
                  </p>
                  <p>
                    <span className='footer_name'>احمد جوادی</span>{' '}
                    <BsFillPersonFill className='footer_icon' />
                  </p>
                </div>
              </div>
            </div>
